...
citation: 'Ihsan Ullah et al. (2021). Video Domain Adaptation for Semantic Segmentation using Perceptual Consistency Matching; <i>Computer Vision and Pattern Recognition (CVPR23)</i>'
---
